...
<div className='columns'>
    ...
    <div className="about">
    <h1>About JosTech</h1>
    <div className='info'><p>{<IoLocationOutline/>} </p> <p>Nairobi,Moi Avenue,Festive Mall,SE</p></div>

    <div className="info"><p>{<SiMinutemailer/>} </p> <Link to="https://github.com/Joseh254">JosTech@info.co.ke</Link></div>
